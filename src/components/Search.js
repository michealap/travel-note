...
export default function Search(props) {
  ...
  if(alert) {
    return (
      <div id="alert">
      <Modal  sx={{ width: "100%", height: "30%"}}
        open={open}
        onClose={handleClose}
      >
        <Alert severity="warning" sx={{justifyContent: "center"}}>Please enter a country name</Alert>
      </Modal>
      </div>
    )
  }
  ...
  return (
    <Box className="logoandsearch">
      <Stack direction="row" spacing={20} pl={50} 
      sx={{justifyContent: "space-evenly",width: "100%"}}>
        ...
        <div className="searchbar">
          <div id="search">
            ...
            style={{padding: "10px"}}/>): (<button type="button" onClick={()=>onSearch()}>)
